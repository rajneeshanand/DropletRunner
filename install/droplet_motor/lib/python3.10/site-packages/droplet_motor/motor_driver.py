#!/usr/bin/env python3
"""
Dynamixel motor driver for DropletRunner.
Receives current (torque) commands and sends to XL330-M077 motors via U2D2.
Uses Current Control Mode (mode 0) — same as CyberRunner.
"""
