...
4. [Software Setup: Laptop (Ubuntu)](#4-software-setup--laptop-ubuntu-see-setup_laptopsh-for-details)
5. [Software Setup: HPC (Sol Cluster)](#5-software-setup--hpc-see-setup_hpcsh-for-details)
...
16. [Important rules and lessons learned](#16-important-rules-and-lessons-learned)
