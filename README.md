...
7. [Defining a New Geometry (End-to-End Example)](#7-defining-a-new-geometry-end-to-end-example)
8. [Phase 1 — Random Data Collection](#8-phase-1--random-data-collection)
